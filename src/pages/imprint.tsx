...
const ImprintPage = () => (
  <Page>
    ...
    <p>
      ...
      are text files which are stored locally on your computer and make it
      possible to track the usage of this website. The generated information
      (including IP-Address) will be forwarded to a server of Google in the
      United States and stored there locally. Google will use this information
      to analyze the usage of this page in order to generate reports about the
      activity of website visitors for the owners of this website and also to
      show related activity and services of this site. Furthermore Google will
      transmit this information to third parties in case it is requested by law
      or to affiliated partners of Google. Google will never connect your
      IP-Address with any related data. You can also block the installation of
      Google cookies manually/automatically through your browser software.
