...
The CI plugin enables the connection of continuous integration systems to the SCM-Manager. In combination with the [scm-review-plugin](https://github.com/scm-manager/scm-review-plugin) in particular, information on code quality and build status can be displayed in pull requests and at the level of individual commits.
